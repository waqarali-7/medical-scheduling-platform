...
import { getAppointmentById } from "@/data/dummy";
import {
  canTransition,
...
const TRANSITION_ICONS: Partial<Record<AppointmentStatus, React.ComponentType<any>>> = {
        ...
        <Box flex={1}>
          <Stack direction="row" spacing={1.5} alignItems="center" flexWrap="wrap">
            <Typography variant="h5" fontWeight={700}>
              Appointment #{appointment.id.replace("apt-", "").padStart(3, "0")}
            </Typography>
              ...
              <Card>
                ...
                <Stack direction="row" spacing={2} alignItems="center" sx={{ mb: 2 }}>
                  ...
                  <Box>
                    ...
                    <Typography variant="caption" color="text.secondary">
                      DOB: {new Date(patient.dateOfBirth).toLocaleDateString("de-DE")}
                    </Typography>
                  </Box>
                </Stack>
